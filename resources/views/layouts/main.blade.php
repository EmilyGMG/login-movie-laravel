  ...
  <nav class="border-b border-gray-800">
    <div class="container mx-auto px-4 flex items-center justify-between px-4 py-6">
      ...
      <div class="flex intems-center">
        <div class="relative">
          <input type="text" class="bg-gray-800 text-sm rounded-full w-64 px-4 pl-8 py-1 focus:outline-none focus:shadow-autline" placeholder="Pesquisar">
        ...
        <div class="ml-4">
          <a href="#">
            <img src="https://avatars2.githubusercontent.com/u/36648933?s=400&u=414f622371d7c485958c2293a2917877da791c45&v=4" alt="avatar" class="rounded-full w-8 h8">
          </a>
        </div>
      </div>
    </div>
