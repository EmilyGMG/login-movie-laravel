...
<head>
    ...
    <title>{{ config('INVICTOS', 'Movies App') }}</title>
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container" style="gap: 40px;">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent" style="gap: 10%;">
                    <!-- Left Side Of Navbar -->
                    ...
                    <li style="width: 80px;">
                        <a href="#" style="font-weight: bold;color: white;font-size: 18px;">Séries</a>
                    </li>
                    <li>
                        <a href="#" style="font-weight: bold;color: white;font-size: 18px;">Filmes</a>
                    </li>
                </ul>
